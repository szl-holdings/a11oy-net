...
def check() -> None:
    ...
    assert (hologram / "index.html").is_file(), "estate OS hologram HTML must exist"
    assert (hologram / "app.js").is_file(), "estate OS hologram script must exist"
    assert (hologram / "data.json").is_file(), "estate OS hologram bake must exist"
    assert (hologram / "os.css").is_file(), "estate OS hologram styles must exist"
    ...
    assert "propose only" in hologram_html.lower() or "propose-only" in hologram_html.lower() or "PROPOSE_ONLY" in hologram_html
